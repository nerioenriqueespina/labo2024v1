...
# ejecutar experimento 5
#
# La idea del experimento 5 consiste en probar el aporte 
# que los lags tienen sobre la ganancia
#
# Para comprobarlo, se habilitará el lag2. En ese sentido, 
# el experimento 5 es identico al 4, pero con los nuevos
...
# por favor notal como este script parte de FE0001_5

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001_5 y parto de alli
...
# DT0001_5, CA0001_5, DR0001_5, FE0001_5, TS0001_5, HT0001_5 y ZZ0001_5
corrida_guantesblancos_202109( "gb01_5" )


# Luego partiendo de  FE0001_5
# genero TS0002_5, HT0002_5 y ZZ0002_5

corrida_guantesblancos_202107( "gb02_5" )
