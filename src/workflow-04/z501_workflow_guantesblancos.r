...
# La idea del experimento 3 consiste en probar el aporte que los lags tienen sobre la ganancia
# Para comprobarlo, se habilitará el lag2. En ese sentido, el experimento 4 es identico al 3, pero con el segundo lag activado
##############################
...
# por favor notal como este script parte de FE0001_4

corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001_4 y parto de alli
...
# DT0001_4, CA0001_4, DR0001_4, FE0001_4, TS0001_4, HT0001_4 y ZZ0001_4
corrida_guantesblancos_202109( "gb01_4" )


# Luego partiendo de  FE0001_4
# genero TS0002_4, HT0002_4 y ZZ0002_4
