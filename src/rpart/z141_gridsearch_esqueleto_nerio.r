...
PARAM$semillas <- c(141223, 258113, 270131, 686087, 832969)
...
# setwd("/home/nespina/") # Establezco el Working Directory
# cargo los datos
    ...
    for (vminbucket in c(2, 10, 20)){
      for (vcp in c(-1, 0, 1)){
        ...
        tb_grid_search <- rbindlist( 
          list( tb_grid_search, 
                list( vcp, vmax_depth, vmin_split, vminbucket, ganancia_promedio) ) )
